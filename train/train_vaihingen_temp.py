...
from models.SFFNetv2_wodffcqp import SFFNet
...
def main():
    ...
    for epoch in range(epoches):
        ...
        with open('./A_modelpath/vaihingen/our/ablation/cqpdff/training_loss.txt', 'a') as file:
        ...
        if epoch % 50 == 0:
            torch.save(model.state_dict(), "./A_modelpath/vaihingen/our/ablation/cqpdff/our_celoss-%d.pth" % (model_id + epoch + 1))
        end = time.time()
        time_cha = end - start
...
if __name__ == '__main__':
    ...
    batch_size = 8
    model_dir = './A_modelpath/vaihingen/our/ablation/cqpdff/'
