...
#from models.SFFNetv2_wofuzzy import SFFNet
#from models.SFFNetv2_wohigh import SFFNet
#from models.SFFNetv2_wolow import SFFNet
#from models.SFFNetv2_wowave import SFFNet
#from models.SFFNetv2_wave5 import SFFNet
#from models.SFFNetv2_wodff import SFFNet
#from models.SFFNetv2_wofuzzycqp import SFFNet
#from models.SFFNetv2_cqp_fuzzyab import SFFNet
#from models.SFFNet_ab_backbone import SFFNet
#from models.SFFNetv2_onlyt2fsc import SFFNet

from models.SFFNetv2_cmfa import SFFNet
from models.SFFNetv2_cmfca import SFFNet
...
def dice_loss(outputs, labels, num_classes=6):
    smooth = 1e-6
...
def main():
    ...
    if torch.cuda.is_available():
        frame_work = SFFNet(num_classes=6)
    ...
    for epoch in range(epoches):
        ...
        with open('./A_modelpath/vaihingen/cmfca/loss.txt', 'a') as file:
        ...
        #if epoch % 50 == 0:
        if epoch % 50 == 0:
            torch.save(model.state_dict(), "./A_modelpath/vaihingen/cmfca/celoss-%d.pth" % (model_id + epoch + 1))
        end = time.time()
        time_cha = end - start
...
if __name__ == '__main__':
    ...
    data_dir = '/home/ps/data/code/wgy/1Awork_02/Datasets/A_Vaihingen_800/'
    batch_size = 8
    model_dir = './A_modelpath/vaihingen/cmfca/'
